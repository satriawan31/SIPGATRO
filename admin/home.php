                        ...
                        <div class="card gradient-1">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    ...
                                    <p class="text-white mb-0" > </p><?php echo date('d M Y');?> </p>
                                </div>
                                ...
                                <div class="card">
                                    <div class="card-body justify-content-between">
                                        <center>
                                                ...
                                                <p style="font-size: 19px;">SISTEM INFORMASI PENDATAAN GARDU TRAFO</p>
                                                <p>Selamat datang di Sistem Informasi Pendataan Gardu Trafo. Silahkan pilih menu yang ada di samping untuk memulai</p>
                                        </center>
